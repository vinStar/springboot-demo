...
import com.example.demo.service.LocalTransactionExecuterImpl;
...
@RestController
@Slf4j
public class TransMqController {

    /**
     * 使用RocketMq的生产者
     */
    @Autowired
    @Qualifier("getTransProducer")
    private TransactionMQProducer transactionMQProducer;

    @Value("${rocketmq.producer.testTopicTrans}")
    String testTopic;
...
//                    sendMsg, new LocalTransactionExecuterImpl(),null);
