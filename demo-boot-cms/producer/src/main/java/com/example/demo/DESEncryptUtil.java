...
public class DESEncryptUtil {
    ...
    public static String encrypt(String data,String key){
        ...
        String strs = null;
        try {
            byte[] bytes = encryptOrDecrypt(Cipher.ENCRYPT_MODE,data.getBytes(),key.getBytes("utf-8"));
            // base64编码字节
    ...
    public static String decrypt(String data,String key){
        ...
        try {
            ...
            byte[] bytes = encryptOrDecrypt(Cipher.DECRYPT_MODE,src,key.getBytes("utf-8"));
    ...
    public static void main(String[] args) {
        ...
        json.put("首联","一叶扁舟伴水流");
        String data = encrypt(json.toJSONString(),"1f2e3d4c5b6a78");
        System.out.println("明文是:"+json);
        System.out.println("加密后:"+data);
        System.out.println("解密后："+decrypt(data,"1f2e3d4c5b6a78"));
    }
