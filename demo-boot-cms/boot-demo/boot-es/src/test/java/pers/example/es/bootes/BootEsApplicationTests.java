...
@SpringBootTest
public class BootEsApplicationTests {
    ...
    public void contextLoads() {
        ...
        try {
            for (int i = 0; i < 10; i++) {
                ...
                Thread.sleep(5000);
                System.out.println(movingFactor + " / One-Time Password : " + generateOTP(secret, movingFactor, codeDigits));
            }
