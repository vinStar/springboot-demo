...
public class QaController {
    ...
    public QaController() {
        System.out.println("QaController construct");
        System.out.println("runtime maxMemory : " + Runtime.getRuntime().maxMemory() / 1024 / 1024);
        System.out.println("runtime totalMemory : " + Runtime.getRuntime().totalMemory() / 1024 / 1024);
        System.out.println(" ");
    }
